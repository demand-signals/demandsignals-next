...
const CATALOG: readonly PricingItem[] = [
  ...
  },
  {
    id: 'site-restyle',
    category: 'existing-site',
    name: 'Site Restyle / Refresh',
    benefit: 'Modern look without replatforming.',
    aiBadge: 'Modern look, same platform',
    type: 'one-time',
    baseRange: [150000, 400000],
    quantifiable: false,
    narrowingFactors: [],
  ...
  },
  {
    ...
    benefit: 'Move everything to a new platform without losing content or SEO.',
    aiBadge: 'Move everything, lose nothing',
    type: 'one-time',
