...
- 3-5 external_sources from authoritative sites (Anthropic, OpenAI, Google blog, official docs, named research firms — NOT random listicle blogs)
...
Return ONLY the JSON object. No preamble. No "I'll research..." No markdown fences.`
