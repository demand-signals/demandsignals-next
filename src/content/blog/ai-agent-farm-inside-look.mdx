...
featured: true
infographic:
  headline: "Inside a 19-Agent AI Farm"
  type: "stats"
  stats:
    - { label: "Active Agents", value: "19" }
    - { label: "Tasks/Day", value: "200+" }
    - { label: "Cost vs Team", value: "80% less" }
---
...
If you want to see what an agent farm deployment looks like for a client engagement — not the internal version, but the client-facing version — visit [DSIG Agent Swarms](/ai-services/ai-agent-swarms) for a full breakdown of how we structure client deployments.
