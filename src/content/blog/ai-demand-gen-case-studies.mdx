...
featured: true
infographic:
  headline: "3 NorCal Case Studies: Real Results"
  type: "stats"
  stats:
    - { label: "Winery Reviews", value: "535% growth" }
    - { label: "Contractor Leads", value: "500% increase" }
    - { label: "Law Firm Consults", value: "650% increase" }
---
