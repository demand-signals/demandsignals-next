...
serviceCategories: ["websites-apps", "content-social"]
featured: false
infographic:
  headline: "Static vs Living Website"
  type: "comparison"
  stats:
    - { label: "Content Pages (3yr)", value: "5 vs 108" }
    - { label: "Long-Tail Entry Points", value: "0 vs 72+" }
    - { label: "AI Citation Chance", value: "Low vs High" }
---
