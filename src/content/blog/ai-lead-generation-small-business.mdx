...
featured: false
infographic:
  headline: "4 Pillars of AI Lead Generation"
  type: "checklist"
  stats:
    - { label: "Response Time", value: "90 seconds" }
    - { label: "Review Velocity", value: "11/month" }
    - { label: "Nurture Conversion", value: "3-4x higher" }
---
...
If you want to see how these four pillars could be implemented for your specific business and market, start with our [local demand generation services](/demand-generation/systems). We'll map out which pillars are weakest in your current setup and where the highest-leverage improvements are.
