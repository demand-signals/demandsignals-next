...
export function AdminSidebar() {
  ...
  return (
    <aside className="w-64 bg-[#2a3244] border-r border-white/15 flex flex-col h-screen sticky top-0">
      ...
      <div className="p-3 border-t border-white/15">
        <button
          ...
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-slate-400 hover:text-white hover:bg-white/10 w-full transition-colors"
        >
