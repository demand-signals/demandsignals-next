    ...
    <>
      ...
      <section style={{ background: '#fff', padding: '56px 24px 64px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          {/* YouTube embed for posts with video */}
          {post.slug === 'anthropic-glasswing-ai-governance-superintelligence' && (
            <div style={{ position: 'relative', width: '100%', paddingBottom: '56.25%', marginBottom: '3rem', borderRadius: '12px', overflow: 'hidden', background: '#000' }}>
              <iframe
                src="https://www.youtube.com/embed/INGOC6-LLv0"
